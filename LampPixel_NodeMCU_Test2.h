...
#define LED_PIN     2  // Pin D2 du NodeMCU
 ...
 *                                          WIFI                        *
*************************************************************************/
const char* ssid = "Your SSID"; // Name of WiFi Network
const char* password = "YourPassword"; // Password of WiFi Network


/************************************************************************
 * Controls                                                             *
 ************************************************************************/
#define POT_ANIM              A0 //pas de A1 dur NodeMCU ==> Voir pour remplacer par une roue codeuse pour permettre de réinitilisé en fonction choix par wifi
#define POT_ANIM_MIN          200
#define POT_ANIM_MAX          800
#define POT_BRIGHTNESS        1 //A0 pas utilisé pour test NODEMCU, 
